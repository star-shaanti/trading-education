      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {guides.map((guide) => (
          <Card
            ...
            title={
              lang === "fr"
                ? guidesFrExtended[guide.id]?.title ?? getTitle(guide.id, guide.title)
                : getTitle(guide.id, guide.title)
            }
            description={
              lang === "fr"
                ? guidesFrExtended[guide.id]?.description ??
                  guidesFr[guide.id]?.description ??
                  guide.description
                : guide.description
            }
